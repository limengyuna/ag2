...
from app.api import auth, chat, document, health, knowledge_base, mcp, skill, task, memory, memory_profile
...
app = FastAPI(
    ...
    description="智能知识库与多 Agent 协作平台",
    version="0.1.0",
    docs_url="/docs",
    redoc_url="/redoc",
